...
namespace softerCell_U3_v0._01
{
    ...
    public static class DBAccessFactory
    {
        ...
        private abstract class DBAccess : IDBAccess
        {
            ...
            protected const string CON_strConnTimeOut = "Connect Timeout = 200";
        ...
        private class SQL : DBAccess
        {
            ...
            public override DataTable Tables
            {
                ...
                get
                {
                    //while (((SqlConnection)base.m_oConn).GetSchema("Tables", null)==null )
                    //{
                    //    throw new Exception("Cmd 参数出错!");
                    //}
                    return ((SqlConnection)base.m_oConn).GetSchema("Tables", null);
                }
